...
\begin{document}
	...
	\frame{\frametitle{The Problem}
		...
		i.e. The heat equation... \\\vspace{1cm}
	...
	\frame{\frametitle{The Transformed Problem}
		...
		where $z$ is the transform variable, $I$ is the identity matrix, $\hat{f}(z)=\L\{f\}$, and $w(z)=\L\{u\}$. 
	}
	...
	\frame{\frametitle{Actual Solution}
		...
		\begin{figure}
			\includemovie[poster, mouse, repeat, text=animation.mpg]{8cm}{6cm}{ProjectFiles/results/movies/animation.mpg}
		\end{figure}
	}
